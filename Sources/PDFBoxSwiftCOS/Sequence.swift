...
internal func +<LHS: Sequence, RHS: Sequence>(
  lhs: LHS,
  rhs: RHS
) -> AnySequence<LHS.Element> where LHS.Element == RHS.Element {
...
extension Sequence {
  ...
  ///
  /// - returns: A new sequence constructed by appending the new element to
  ///            the beginning of the base sequence.
