...
extension COSName {
  ...
  public static let changes = COSName(name: "Changes")
  ...
  public static let propAuthTime = COSName(name: "Prop_AuthTime")
  public static let propAuthType = COSName(name: "Prop_AuthType")
  ...
  public static let reference = COSName(name: "Reference")
  ...
  private static let commonNameMap: [String : COSName] = [
    ...
    propAuthTime.name                : propAuthTime,
    propAuthType.name                : propAuthType,
